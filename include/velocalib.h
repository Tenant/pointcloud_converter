...
public:
    ...
    std::vector<size_t> idx; /**< 从上至下的激光线索引，0-63, 如对最低垂直角度激光线l,其在packet中的id即为idx[0] */
    std::vector<size_t> order;/**< 激光线对应的大小顺序,0-63, 如激光id为0的激光线,其垂直方向角度按从低到高排序为order[0]*/
};
